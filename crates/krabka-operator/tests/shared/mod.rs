...
pub fn fake_converged_sts_body(
    ...
    statefulset["spec"]["template"]["metadata"]["annotations"] =
        serde_json::json!({ "krabka.io/config-hash": config_hash });
...
pub fn fake_topic_body(name: &str, namespace: &str) -> serde_json::Value {
    serde_json::json!({
        ...
        "metadata": {
            ...
            "uid": "topic-uid",
            "generation": 1,
            "finalizers": ["krabka.io/topic-finalizer"],
        },
        "spec": {
            "partitions": 3,
            "replicas": 1,
...
pub fn fake_pool_body(name: &str, namespace: &str, parent: &str) -> serde_json::Value {
    serde_json::json!({
        ...
        "metadata": {
            ...
            "namespace": namespace,
            "uid": "pool-uid",
            "labels": { "krabka.io/cluster": parent }
        },
        "spec": {
...
pub fn op_config(namespace: &str) -> OperatorConfig {
    OperatorConfig {
        ...
        controller_drift_requeue: krabka_units::minutes(1),
        controller_invalid_requeue: krabka_units::minutes(5),
        controller_certificate_requeue: krabka_units::secs(10),
        user_tls_drift_requeue: krabka_units::hours(6),
        ...
        rebalancer_request_timeout: krabka_units::secs(30),
        rebalancer_poll_interval: krabka_units::secs(10),
        rebalancer_idle_interval: krabka_units::minutes(5),
        delegation_token_invalid_requeue: krabka_units::hours(1),
        delegation_token_transient_backoff: krabka_units::minutes(5),
        delegation_token_min_requeue: krabka_units::minutes(1),
        delegation_token_max_requeue: krabka_units::hours(24),
...
pub fn pool_cr(name: &str, namespace: &str, parent: &str, replicas: i32) -> KafkaNodePool {
    ...
    p.metadata.finalizers = Some(vec!["krabka.io/kafka-node-pool-finalizer".into()]);
    let mut labels = BTreeMap::new();
    labels.insert("krabka.io/cluster".into(), parent.into());
...
/// Carries `metadata.labels["krabka.io/cluster"] = kafka_name` and a `uid`.
pub fn fake_gateway_body(name: &str, namespace: &str, kafka_name: &str) -> serde_json::Value {
    serde_json::json!({
        ...
        "metadata": {
            ...
            "uid": "gw-uid",
            "generation": 1,
            "labels": { "krabka.io/cluster": kafka_name }
        },
        "spec": {
            "webhooks": [],
