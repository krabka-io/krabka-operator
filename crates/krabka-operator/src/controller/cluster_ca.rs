...
/// key promotion.
pub(crate) const ANN_CERT_GENERATION: &str = "krabka.io/ca-cert-generation";
...
/// the key.
pub(crate) const ANN_KEY_GENERATION: &str = "krabka.io/ca-key-generation";
...
pub(crate) const ANN_LEAFS_KEY_GENERATION: &str = "krabka.io/ca-leafs-key-generation";
/// Annotation on the cert Secret that records the staged key-replacement
/// phase.
pub(crate) const ANN_ROTATION_PHASE: &str = "krabka.io/ca-rotation-phase";
...
pub const ANN_FORCE_RENEW: &str = "krabka.io/force-renew-ca";
/// `Kafka` CR annotation: force a staged CA key replacement on the next reconcile.
pub const ANN_FORCE_REPLACE_KEY: &str = "krabka.io/force-replace-ca-key";
/// `Kafka` CR annotation: force a staged clients-CA key replacement.
pub const ANN_FORCE_REPLACE_CLIENTS_KEY: &str = "krabka.io/force-replace-clients-ca-key";
...
pub const ANN_RENEW_AFTER: &str = "krabka.io/ca-renew-after";
...
///
/// The operator stores it in the `krabka.io/ca-rotation-phase` annotation
...
pub(crate) struct RotationInputs {
    ...
    pub validity: Time,
    pub renewal: Time,
    /// `krabka.io/force-renew-ca` present on the `Kafka` CR.
...
fn render_ca_secret(
    ...
    labels.insert("krabka.io/secret-type".into(), secret_type_label.into());
    labels.insert("krabka.io/cluster".into(), cluster);
    let mut annotations = BTreeMap::new();
    annotations.insert("krabka.io/strictly-operator-managed".into(), "true".into());
...
pub(crate) async fn emit_event(
    ...
    let event = Event {
        ...
        involved_object: k8s_openapi::api::core::v1::ObjectReference {
            api_version: Some("krabka.io/v1alpha1".into()),
        ...
        reporting_instance: Some(
            std::env::var("POD_NAME").unwrap_or_else(|_| "krabka-operator-renewal".into()),
        ),
        ..Default::default()
    };
