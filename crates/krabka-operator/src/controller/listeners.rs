...
pub fn render_broker_service(
    ...
    labels.insert("krabka.io/listener".into(), listener.name.clone());
    labels.insert("krabka.io/broker".into(), broker_id.to_string());
...
pub fn render_bootstrap_service(
    ...
    labels.insert("app.kubernetes.io/instance".into(), cluster_name.clone());
    labels.insert("krabka.io/listener".into(), listener.name.clone());
    labels.insert("krabka.io/role".into(), "bootstrap".into());
    ...
    selector.insert("krabka.io/broker-role".into(), "true".into());
...
mod service_rendering_tests {
    ...
    fn bootstrap_service_selects_all_broker_pods() {
        ...
        check!(sel.get("krabka.io/broker-role") == Some(&"true".to_string()));
